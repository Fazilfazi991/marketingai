...
export type DataImport={id:number;source:"Google Analytics 4"|"Search Console";property:string;range:string;status:"Running"|"Completed"|"Failed";rows:number;at:string;isDemo:boolean;error?:string};
