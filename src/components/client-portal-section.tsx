  ...
  if (!report)
    return (
      <Panel
        ...
        meta="Published reports only"
      >
        <div className="empty-state">
          <b>No monthly report has been published yet.</b>
          <p>
  ...
  return (
    <>
      <div className="report-toolbar">
        <div>
          <label htmlFor="client-report-month">Report month</label>
          <select
      ...
      <div className="report-hero">
        <div>
          <span>
            {report.monthLabel} · {data.isDemo ? "Demo preview" : "Published"}
          </span>
      ...
      <div className="client-kpis">
        <div>
          ...
          <small>{data.isDemo ? "Demo" : "Verified result"}</small>
        </div>
        <div>
